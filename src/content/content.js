...
export const content = {
  en: {
    ...
    monitor: {
      ...
      // earthquake section (TMD feed, ingested hourly into Supabase)
      eqEyebrow: "Live / Earthquake Feed",
      eqTitle: "Earthquake Monitor",
      eqSubtitle:
        "Seismic events from the Thai Meteorological Department, ingested hourly into Supabase. This checks whether that pipeline is actually still landing data — not just whether a quake happened recently.",
      eqSourceLive: "Live — reaching Supabase",
      eqSourceStale: "Stale — pipeline hasn't written in a while",
      eqSourceOffline: "Not reaching Supabase",
      eqSourceUnconfigured: "Supabase isn't linked yet",
      eqLastFetch: "Last pipeline write",
      eqFetchAge: "Age",
      eqSourceExplain:
        "“Live” means the hourly TMD fetch has landed a row in Supabase recently — independent of whether a new earthquake actually happened.",
      eqStat24h: "Events · 24h",
      eqStatDomestic24h: "Domestic · 24h",
      eqStatLatestEvent: "Latest event",
      eqColDatetime: "Time (Bangkok)",
      eqColMagnitude: "Magnitude",
      eqColDepth: "Depth",
      eqColLocation: "Location",
      eqColOrigin: "Origin",
      eqDomestic: "Domestic",
      eqForeign: "Foreign",
      eqNoResults: "No recent earthquake events.",
      eqError: "Couldn't reach the earthquake feed.",
      eqUnitKm: "km",
    },
    education: {
  ...
  th: {
    ...
    monitor: {
      ...
      // ส่วนแผ่นดินไหว (ฟีดจากกรมอุตุฯ ดูดเข้า Supabase ทุกชั่วโมง)
      eqEyebrow: "Live / ฟีดแผ่นดินไหว",
      eqTitle: "มอนิเตอร์แผ่นดินไหว",
      eqSubtitle:
        "ข้อมูลแผ่นดินไหวจากกรมอุตุนิยมวิทยา ดูดเข้า Supabase ทุกชั่วโมง ส่วนนี้ตรวจว่า pipeline ยังส่งข้อมูลเข้าระบบจริงหรือไม่ — ไม่ใช่แค่ว่ามีแผ่นดินไหวเกิดขึ้นล่าสุดหรือเปล่า",
      eqSourceLive: "ส่งข้อมูลจริง — เข้าถึง Supabase",
      eqSourceStale: "ข้อมูลค้าง — pipeline ไม่ได้เขียนมาสักพัก",
      eqSourceOffline: "ไม่มีข้อมูลเข้า Supabase",
      eqSourceUnconfigured: "ยังไม่ได้เชื่อม Supabase",
      eqLastFetch: "เขียนล่าสุดโดย pipeline",
      eqFetchAge: "อายุ",
      eqSourceExplain:
        "“ส่งข้อมูลจริง” หมายถึง pipeline ที่ดูดข้อมูลจาก TMD ทุกชั่วโมง เพิ่งเขียนแถวใหม่เข้า Supabase เมื่อไม่นานนี้ — ไม่เกี่ยวกับว่าเพิ่งมีแผ่นดินไหวเกิดขึ้นจริงหรือไม่",
      eqStat24h: "เหตุการณ์ · 24 ชม.",
      eqStatDomestic24h: "ในประเทศ · 24 ชม.",
      eqStatLatestEvent: "เหตุการณ์ล่าสุด",
      eqColDatetime: "เวลา (กรุงเทพฯ)",
      eqColMagnitude: "ขนาด",
      eqColDepth: "ความลึก",
      eqColLocation: "ตำแหน่ง",
      eqColOrigin: "แหล่งที่มา",
      eqDomestic: "ในประเทศ",
      eqForeign: "ต่างประเทศ",
      eqNoResults: "ไม่มีเหตุการณ์แผ่นดินไหวล่าสุด",
      eqError: "เชื่อมต่อฟีดแผ่นดินไหวไม่ได้",
      eqUnitKm: "กม.",
    },
    education: {
      eyebrow: "04 / การศึกษา",
